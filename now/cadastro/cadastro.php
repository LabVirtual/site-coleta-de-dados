    ...
    <div class="container">
      ...
      <form action="send.php" method="post" >
        ...
        <div class="form-group col-md-3">
          ...
          <input name="cpf" type="number" class="form-control" id="inputAddress" placeholder="01815918-13">
        </div>
        ...
        <div class="form-row">
                <div class="form-inline">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                          ...
                          <input name="email2" type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Ex: ileel.com">
                        </div>
        ...
        <div class="form-group col-md-4">
                ...
                <select name="se" id="inputState" class="form-control">
        ...
        <button name="btn" type="submit" class="btn btn-primary">Cadastrar</button>
      </form>
